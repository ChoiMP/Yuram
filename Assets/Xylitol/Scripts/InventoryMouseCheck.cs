    ...
    {  
        switch(relic)
        {
            case "hp":
                ...
                relicEffect.text = "전체 유닛\n" + "체력 "  + RelicStatus.instance.applied_HP_Value  + " 증가";
                break;
            case "mp":
                relicName.text = "영겁의 지팡이";
                relicEffect.text = "전체 유닛\n" + "마나 " + + RelicStatus.instance.applied_MP_Value +  " 증가";
                break;
            case "power":
                relicName.text = "수호 천사";
                relicEffect.text = "전체 유닛\n" + "공격력 " +  RelicStatus.instance.applied_POWER_Value + "% 증가";
                break;
            case "skill":
                relicName.text = "음전자 망토";
                relicEffect.text = "전체 유닛\n" + "스킬 업그레이드 "  + RelicStatus.instance.applied_SKILL_Value +  " 단계";
                break;
            case "speed":
                relicName.text = "망령의 두건";
                relicEffect.text = "전체 유닛\n" + "속도 " +  RelicStatus.instance.applied_SPEED_Value + "% 증가";
                break;
        }
    }
